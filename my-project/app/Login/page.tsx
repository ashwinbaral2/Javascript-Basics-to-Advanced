...
const Login = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col gap-3 items-center justify-center text-white  font-sans bg-linear-to-tr from-black via-indigo-800 to-violet-800">
            ...
            <a href="#" className=" text-white p-1 hover:text-indigo-400">forgot password?</a>
