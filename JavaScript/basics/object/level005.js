...
function freezeExcept(obj, allowedKeys) {

    Object.seal(obj);
    // now, you cannot add or delete keys -- its sealed

    Object.keys(person).forEach((key) => {
        if (!allowedKeys.includes(key)) {
            const desc = Object.getOwnPropertyDescriptor(person, key);
            Object.defineProperty(person, key, { ...desc, writable: false });
