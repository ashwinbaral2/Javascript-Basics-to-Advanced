...
// ==========================================
// SECTION 1: Map Method, Logical Operations
// ==========================================
/***********************************************************
 * 1. //AND(&&), OR(||), NOT(!) ---> Examples: Check Age Category
 ***********************************************************/
const checkAge = (age) => {
    if (age > 0 && age < 10) {
...
/***********************************************************
 * 2. Using map() ---> Example: Double Each Number
 ***********************************************************/
...
// ============================================================================
// SECTION 2: Object (key and value) and this.operators 
// ============================================================================
